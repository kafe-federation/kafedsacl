...
foreach ($this->data['idplist'] as $idpentry) {
    ...
    if(acl($sp_entityid, $idp_entityid)) {
        continue;
    }
...
<link rel="shortcut icon" href="<?php echo $KAFE_URI;?>/images/favicon.ico">
<link type="text/css" rel="stylesheet" href="<?php echo $KAFE_URI;?>/style.css"/>
</head>
